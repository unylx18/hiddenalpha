                  ...
                  (
                    ...
                    return (
                      <Link
                        ...
                        className={`group flex items-center gap-3 rounded-xl border px-3 py-2.5 text-[12px] transition ${
                          active
                            ? "border-violet-500/10 bg-violet-500/[0.10] text-zinc-100"
                            : "border-transparent text-zinc-500 hover:bg-white/[0.025] hover:text-zinc-300"
                        }`}
                      >
              ...
              <div className="flex h-[64px] items-center gap-3 px-4 lg:px-5">
                ...
                <div className="hidden max-w-[430px] flex-1 md:block">
                  ...
                  <div className="flex h-9 items-center gap-2 rounded-lg border border-white/[0.055] bg-[#0a0d13] px-3">
                    ...
                    <input
                      placeholder="Search assets, signals, scanner, tools..."
